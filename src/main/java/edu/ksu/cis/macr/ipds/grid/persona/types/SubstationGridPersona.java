 ...
 */
public class SubstationGridPersona extends GridPersona {
   ...
   */
  public SubstationGridPersona(final IOrganization organization,
                               final String identifier, final Element knowledge, OrganizationFocus focus) {
    super(organization, identifier, knowledge, focus);
  }

  public SubstationGridPersona(final String identifier) {
    super(identifier);
  }

  @Override
  public String toString() {
    return "Substation Grid Agent";
  }
