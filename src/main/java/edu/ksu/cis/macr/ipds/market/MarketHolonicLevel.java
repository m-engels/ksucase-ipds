...
public enum MarketHolonicLevel {
     ...
     * @return string that contains the kind of organization type based off first letter.
     */
    public static MarketHolonicLevel getOrganizationType(final String
                                                                 organizationName) {

        String name = organizationName.replace("self", "").replace("org",
                "").toUpperCase().trim();
        String firstChar = name.substring(0, 1);
        MarketHolonicLevel t = MarketHolonicLevel.Home;
     ...
     * @return string that contains the kind of organization type based off first letter.
     */
    public static MarketHolonicLevel getDefaultControllerOrganizationType(final
