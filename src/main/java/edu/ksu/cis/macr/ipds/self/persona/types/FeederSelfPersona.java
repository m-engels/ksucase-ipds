 ...
 */
public class FeederSelfPersona extends SelfPersona {
   ...
   */
  public FeederSelfPersona(final IOrganization organization, final String identifier, final Element knowledge, OrganizationFocus focus) {
    super(organization, identifier, knowledge, focus);
  }

  public FeederSelfPersona(final String identifier) {
    super(identifier);
  }

  @Override
  public String toString() {
    return "Feeder Self Agent";
  }
