 ...
 */
public class NeighborhoodGridPersona extends GridPersona {
   ...
   */
  public NeighborhoodGridPersona(final IOrganization organization,
                                 final String identifier, final Element knowledge, OrganizationFocus focus) {
    super(organization, identifier, knowledge, focus);
  }

  public NeighborhoodGridPersona(final String identifier) {
    super(identifier);
  }

  @Override
  public String toString() {
    return "Neighborhood Grid Agent";
  }
