 ...
 */
public class Forecast_Lateral_Plan extends AbstractExecutablePlan {

  public Forecast_Lateral_Plan() {
    getStateMachine().setCurrentState(Forecast_Lateral_Init.Instance());
  }
