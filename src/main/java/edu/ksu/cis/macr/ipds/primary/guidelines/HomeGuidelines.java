...
public class HomeGuidelines implements Serializable, IHomeGuidelines  {
     ...
     */
    private HomeGuidelines(double minVoltageMultiplier, double maxVoltageMultiplier,
    ...
    public static IHomeGuidelines createHomeGuidelines(double minVoltageMultiplier, double maxVoltageMultiplier,
                                                       double constantInelasticLoad_fraction) {
        return new HomeGuidelines(minVoltageMultiplier, maxVoltageMultiplier, constantInelasticLoad_fraction);
    }
