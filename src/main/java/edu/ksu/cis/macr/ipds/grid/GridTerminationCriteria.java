...
*/
public class GridTerminationCriteria extends DefaultTerminationCriteria {
   ...
   */
  public GridTerminationCriteria(final Organization organization) {
  ...
  public static void setIsDone(final boolean isDone) {
    GridTerminationCriteria.isDone = isDone;
  }
