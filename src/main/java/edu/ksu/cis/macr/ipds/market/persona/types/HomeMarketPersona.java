 ...
 */
public class HomeMarketPersona extends MarketPersona {
     ...
     */
    public HomeMarketPersona(final IOrganization organization,
     ...
     * @param identifier a string containing the unique name of this agent.
     */
    public HomeMarketPersona(final String identifier) {
        super(identifier);
    }

    @Override
    public String toString() {
        return "Home Market Agent";
    }
}
