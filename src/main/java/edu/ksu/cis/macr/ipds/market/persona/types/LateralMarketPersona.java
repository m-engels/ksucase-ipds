 ...
 */
public class LateralMarketPersona extends MarketPersona {
     ...
     */
    public LateralMarketPersona(final IOrganization organization,
                                final String identifier, final Element knowledge, OrganizationFocus focus) {
        super(organization, identifier, knowledge, focus);
    }

    public LateralMarketPersona(final String identifier) {
        super(identifier);
    }

    @Override
    public String toString() {
        return "Lateral Market Agent";
    }
}
