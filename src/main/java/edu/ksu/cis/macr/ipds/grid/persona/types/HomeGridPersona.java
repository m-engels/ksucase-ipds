 ...
 */
public class HomeGridPersona extends GridPersona {
   ...
   */
  public HomeGridPersona(final IOrganization organization,
  ...
  /**
   ...
   @param identifier a string containing the unique name of this agent.
   */
  public HomeGridPersona(final String identifier) {
    super(identifier);
  }

    @Override
    public String toString() {
        return "Home Grid Agent";
    }
