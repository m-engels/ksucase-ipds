 ...
 */
public class NeighborhoodPersona extends Persona {
   ...
   */
  public NeighborhoodPersona(final IOrganization organization,
                             final String identifier, final Element knowledge, OrganizationFocus focus) {
      super(organization, identifier, knowledge, focus);
  }

  public NeighborhoodPersona(final String identifier) {
    super(identifier);
  }

  @Override
  public String toString() {
    return "Neighborhood Agent";
  }
