 ...
 *
 */
package edu.ksu.cis.macr.ipds.grid.roles;
...
/**
 ...
 name strings.
 */
public class GridRoleIdentifiers {

  public static final UniqueIdentifier Auction_Power_Role =  StringIdentifier.getIdentifier("Auction Power Role");
    public static final UniqueIdentifier Broker_Power_Role =
            StringIdentifier.getIdentifier("Broker Power Role");

  public static final UniqueIdentifier Be_Holon_Role =
          StringIdentifier.getIdentifier("Be Holon Role");
  ...
  public static final UniqueIdentifier Be_Super_Holon_Role =
          StringIdentifier.getIdentifier("Be Super Holon Role");
  ...
  public String toString() {
    try {
      ...
      Logger.getLogger(GridRoleIdentifiers.class.getName()).log(Level.SEVERE,
              null, ex);
      return "";
    }
