...
public class IssueGridAssignmentsCapability extends AbstractOrganizationCapability {

  private static final Logger LOG = LoggerFactory.getLogger(IssueGridAssignmentsCapability.class);
   ...
   */
  public IssueGridAssignmentsCapability(final IPersona owner, final IOrganization org) {
    super(IssueGridAssignmentsCapability.class, owner, org);
  }
  ...
  public Set<Agent<?>> getLocalRegisteredProsumers(Set<Agent<?>> allAgents) {
    ...
    final Class<?> capabilityClass = GridControlHolonCapability.class;
