 ...
 *
 */
package edu.ksu.cis.macr.ipds.market.persona.types;


import edu.ksu.cis.macr.aasis.agent.persona.IOrganization;
import edu.ksu.cis.macr.aasis.spec.OrganizationFocus;
import edu.ksu.cis.macr.ipds.market.persona.MarketPersona;
 ...
 */
public class NeighborhoodMarketPersona extends MarketPersona {
     ...
     */
    public NeighborhoodMarketPersona(final IOrganization organization,
                                     final String identifier, final Element knowledge, OrganizationFocus focus) {
        super(organization, identifier, knowledge, focus);
    }

    public NeighborhoodMarketPersona(final String identifier) {
        super(identifier);
    }

    @Override
    public String toString() {
        return "Neighborhood Market Agent";
    }
