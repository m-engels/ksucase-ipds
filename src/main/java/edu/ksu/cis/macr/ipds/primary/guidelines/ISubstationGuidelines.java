...
/**
 The {@code ISubstationGuidelines} provide information about the guidelines for power quality for this participant in the
 organization.
 */
public interface ISubstationGuidelines {
