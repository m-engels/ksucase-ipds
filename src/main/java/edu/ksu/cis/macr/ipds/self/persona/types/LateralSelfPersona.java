 ...
 */
public class LateralSelfPersona extends SelfPersona {
   ...
   */
  public LateralSelfPersona(final IOrganization organization,
                            final String identifier, final Element knowledge, OrganizationFocus focus) {
    super(organization, identifier, knowledge, focus);
  }

  public LateralSelfPersona(final String identifier) {
    super(identifier);
  }

  @Override
  public String toString() {
    return "Lateral Self Agent";
  }
}
