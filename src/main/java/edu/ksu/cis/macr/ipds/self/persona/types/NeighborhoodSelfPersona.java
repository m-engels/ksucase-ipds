 ...
 */
public class NeighborhoodSelfPersona extends SelfPersona {
   ...
   */
  public NeighborhoodSelfPersona(final IOrganization organization,
  ...
  public NeighborhoodSelfPersona(final String identifier) {
    super(identifier);
  }
