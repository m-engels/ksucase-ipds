 ...
 */
public class Forecast_Feeder_Init implements IPlanState<Forecast_Feeder_Plan> {
  private static final Forecast_Feeder_Init instance = new Forecast_Feeder_Init();

  private static final Logger LOG = LoggerFactory
          .getLogger(Forecast_Feeder_Init.class);

  private Forecast_Feeder_Init() {
  }

  /**
   @return the singleton instance
   */
  public static Forecast_Feeder_Init Instance() {
    return instance;
  }
  ...
  public synchronized void Execute(final IExecutablePlan plan,
    ...
    if ((RunManager.isStopped())) {
      plan.getStateMachine().changeState(
              Forecast_Feeder_Stop.Instance(), ec,
              ig);
    }
  }
