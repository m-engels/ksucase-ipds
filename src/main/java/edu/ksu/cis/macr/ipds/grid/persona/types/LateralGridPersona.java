 ...
 */
public class LateralGridPersona extends GridPersona {
   ...
   */
  public LateralGridPersona(final IOrganization organization,
                            final String identifier, final Element knowledge, OrganizationFocus focus) {
    super(organization, identifier, knowledge, focus);
  }

  public LateralGridPersona(final String identifier) {
    super(identifier);
  }

  @Override
  public String toString() {
    return "Lateral Grid Agent";
  }
}
