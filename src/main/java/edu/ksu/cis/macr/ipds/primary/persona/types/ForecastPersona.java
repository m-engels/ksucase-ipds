...
/**
 A forecaster agent can forecast generation, load, and weather for its associated organization-agent.
 */
public class ForecastPersona extends Persona {

  /**
   Constructs a new instance of a forecaster agent in accordance with the provided information. Additional agent
   ...
   */
  public ForecastPersona(final IOrganization organization, final String identifier, final Element knowledge, OrganizationFocus focus) {
    super(organization, identifier, knowledge, focus);
  }

  /**
   Constructs a new instance of a forecast agent in accordance with the provided information. Additional agent
   capabilities can be specified in the agent configuration file (e.g. Agent.xml).

   @param identifier a string containing the unique name of this agent.
   */
  public ForecastPersona(final String identifier) {
    super(identifier);
  }
