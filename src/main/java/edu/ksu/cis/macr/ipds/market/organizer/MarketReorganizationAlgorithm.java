 ...
 */
public class MarketReorganizationAlgorithm extends AbstractReorganizationAlgorithm {

    private static final Logger LOG = LoggerFactory.getLogger(MarketReorganizationAlgorithm.class);
     ...
     */
    private MarketReorganizationAlgorithm(String owner) {
        super();
        MarketReorganizationAlgorithm.owner = owner;
    }

    public static MarketReorganizationAlgorithm createReorganizationAlgorithm(final String owner) {
        return new MarketReorganizationAlgorithm(owner);
    }
